                ...
                <ul role='list' className='mt-6 space-y-4'>
                  {navigation.ourLibrary.map(item => (
                    <li key={item.name}>
                      <a
                        href={item.href}
                        className='text-sm/6 text-white hover:text-yellow-500 hover:font-extrabold transition'
                      >
                        {item.name}
                      </a>
                    </li>
              ...
              <div className='mt-10 md:mt-0'>
                ...
                <ul role='list' className='mt-6 space-y-4 text-sm text-white'>
                  <li className='flex items-base gap-2'>
                    ...
                    <div>
                      ...
                      <Link
                        ...
                        className='block font-semibold mt-2 text-white hover:text-yellow-500 hover:font-extrabold transition'
                      >
                        Google map →
                      </Link>
                    </div>
                  ...
                  <li className='flex items-center gap-2'>
                    ...
                    <Link
                      href='tel:022334999'
                      className='text-white hover:text-yellow-500 hover:font-extrabold transition'
                    >
                      {/* 08 3173 6675 */}
                      02-233 4999
                    </Link>
