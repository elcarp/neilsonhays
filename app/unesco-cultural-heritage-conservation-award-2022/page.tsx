  ...
  const awardDetails = [
    {
      ...
      description: 'The highest recognition for cultural heritage conservation in the Asia-Pacific region',
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto">
              The Neilson Hays Library was built in 1922 by an Italian architect, Mario Tamagno, and is an enduring testament to the wave of modernization that began with King Rama V (r.1868-1910).
            </p>
          </motion.div>
            ...
            {awardDetails.map((detail, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-white font-semibold text-lg mb-2">{detail.title}</h3>
      ...
      <section ref={significanceRef} className="py-20 px-4 bg-gray-900">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold text-white mb-4">UNESCO Recognition</h2>
            <p className="text-xl text-gray-300">
              The restoration demonstrates a nuanced understanding of the spirit of place
            </p>
          </motion.div>
          ...
          >
            <blockquote className="text-2xl italic text-white text-center">
              &ldquo;The restoration demonstrates a nuanced understanding of the spirit of place, which is well-respected and enhanced through careful research and investigation.&rdquo;
            </blockquote>
            <p className="text-center text-gray-300 mt-4">— UNESCO Jury Statement</p>
          </motion.div>
      ...
      <section ref={acceptanceRef} className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold text-white mb-4">Acceptance Speech</h2>
            <p className="text-xl text-gray-300">
          ...
          >
            <blockquote className="text-xl italic text-white mb-6">
              &ldquo;A labor of love by all who were involved coming together to dedicate themselves to both preserve a piece of history, and to propel their beloved library forward.&rdquo;
            </blockquote>
            <p className="text-gray-300">— Nalin Vanasin, Library Association President</p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-yellow-900/20 p-6 rounded-lg border border-yellow-700">
              <h3 className="text-2xl font-bold text-white mb-4">Key Contributors</h3>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <h4 className="text-lg font-semibold text-white mb-2">Major Donors</h4>
      ...
      <section ref={juryRef} className="py-20 px-4 bg-gray-900">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold text-white mb-4">Jury Deliberations</h2>
            <p className="text-xl text-gray-300">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
                <h3 className="text-xl font-bold text-white mb-3">Award of Excellence</h3>
                <p className="text-gray-300">
                  The Chhatrapati Shivaji Maharaj Vastu Sangrahalaya in Mumbai, India
                </p>
              </div>

              <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
                <h3 className="text-xl font-bold text-white mb-3">Awards of Merit</h3>
                <p className="text-gray-300">
                  Topdara Stupa, Charikar, Afghanistan, and Nantian Buddhist Temple, Fujian, China
                </p>
              </div>
            </div>
            ...
            <div className="bg-green-900/20 p-8 rounded-lg border border-green-700">
              <blockquote className="text-xl italic text-white mb-4">
                &ldquo;The awards give people a sense of pride and sense of ownership of their own heritage.&rdquo;
              </blockquote>
              <p className="text-gray-300">— Feng Jing, Chief of the Culture Unit at UNESCO Bangkok</p>
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join the Library community by becoming a member to support this heritage building into the future!
            </p>
