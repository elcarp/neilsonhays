...
import { WpPost, WpCategory, getPosts, getCategories, extractTextFromHtml, formatPostDate, getReadingTime } from '@/lib/wp-posts'
...
export default function BlogPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const { posts: fetchedPosts, totalPosts: total, totalPages: pages } = await getPosts(params)
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-600 mb-4 line-clamp-3">
                        {extractTextFromHtml(post.excerpt.rendered || post.content.rendered, 150)}
                      </p>
