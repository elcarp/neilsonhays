...
export default function VenueHire() {
  ...
  const correctPassword = '1neilson^hays9library%'

  useEffect(() => {
    // Check if user is already authenticated (stored in sessionStorage)
    const authenticated = sessionStorage.getItem('venue-authenticated')
  ...
  const handlePasswordSubmit = (e: React.FormEvent) => {
    ...
    if (password === correctPassword) {
      setIsAuthenticated(true)
      sessionStorage.setItem('venue-authenticated', 'true')
      setError('')
    } else {
  ...
  if (!isAuthenticated) {
    return (
      <div className='min-h-screen bg-gradient-to-br from-teal-500 to-teal-600 flex items-center justify-center px-4'>
        <div className='bg-white rounded-xl shadow-2xl p-8 w-full max-w-md'>
          <div className='text-center mb-8'>
            ...
            <p className='text-gray-600'>
              Please enter the password to access the venue hire information.
            </p>
          </div>
          ...
          <div className='mt-8 pt-6 border-t border-gray-200 text-center'>
            <p className='text-sm text-gray-500'>
              ...
              <a
                href='mailto:office@neilsonhayslibrary.org'
                className='text-teal-600 hover:underline'
              >
                office@neilsonhayslibrary.org
              </a>
            </p>
          </div>
        </div>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16'>
        ...
        <div className='mb-12 sm:mb-16'>
          ...
          >
            ...
            <p className='text-base sm:text-lg text-teal-700 text-center mb-8 sm:mb-12 max-w-3xl mx-auto px-4'>
              Explore our beautiful spaces and see how events come to life at
