...
export default function CartPage() {
  ...
  return (
    <div className='min-h-screen bg-teal-500 pb-12 pt-48'>
      <div className='max-w-4xl mx-auto px-4'>
        {/* Header */}
                    ...
                    <div className='flex items-center space-x-4'>
                      ...
                      <div className='flex-1 min-w-0'>
                        {item.slug ? (
                          <Link href={`/products/${item.slug}`} className='block'>
                            <h3 className='text-lg font-medium text-gray-900 truncate hover:text-teal-600 transition-colors'>
                              {item.name}
                            </h3>
                          </Link>
                        ) : (
                      ...
                      <div className='flex items-center space-x-3'>
                        <div className='flex items-center border border-gray-300 rounded-md'>
                          ...
                          <span
                            className={`px-4 py-2 font-medium min-w-[3rem] text-center ${updatingItems.has(item.id) ? 'opacity-50' : ''
                              }`}
                          >
                            {item.quantity}
                          </span>
                        ...
                        <button
                          ...
                          className='p-2 text-red-500 hover:text-red-700 hover:bg-red-50 rounded-md cursor-pointer'
                          title='Remove item'
                        >
            ...
            <div className='bg-white rounded-lg shadow-sm sticky top-6'>
              ...
              <div className='p-6 space-y-4'>
                ...
                <Button
                  ...
                  className='w-full bg-teal-600 hover:bg-teal-700 text-white py-3 cursor-pointer'
                >
