  ...
  return (
    <>
      <div className='py-10 bg-teal-500'>
        <span className='opacity-0'>empty space</span>
      </div>
        ...
        <div className='max-w-6xl mx-auto px-4 pb-12'>
          <div className='grid lg:grid-cols-2 gap-12'>
            ...
            <div className='space-y-6'>
              ...
              {/* <div className='flex items-center space-x-2'>
                <div
                  className={`w-3 h-3 rounded-full ${isOutOfStock ? 'bg-red-500' : 'bg-green-500'
                    }`}
                />
                <span
              ...
              <div className='space-y-3'>
                <div className='flex space-x-3'>
                  <Button
                    ...
                    className='flex-1 bg-gray-700 hover:bg-gray-800 cursor-pointer'
                  >
                    {addingToCart ? (
                      <>
